    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('write.post')}}">Write Post</a>
                </li>
                <li class="nav-item">
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/toaster.js/latest/js/toaster.min.js"></script>
